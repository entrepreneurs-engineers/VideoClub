...
/**
 * Almacena las constantes para la configuracion
 * o ejecución de instrucciones de base de datos
 * @author davigofr
 */
public class ConstantesBD {
    ...
    */
    ...
    public static final String ACTUALIZAR_PELICULA = "actualizarpelicula";
    public static final String OBTENER_PELICULA = "obtenerpelicula";
}
